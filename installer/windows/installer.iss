...
Root: HKCR; Subkey: "*\shell\CityTierStats\command"; ValueType: string; ValueData: "cmd /v:on /k ""echo. & echo Selected file: %1 & echo. & """"{app}\city-tier-stats.exe"""" ""%1"""""""; Flags: uninsdeletekey
