...
- 新增 `--group-by` 参数，支持在整体统计之外按“企微名称”或指定列追加城市分层统计。
- 支持识别空白分组，并按照分组在输入文件中的首次出现顺序输出结果。
...
- Windows 右键菜单、“发送到”菜单和 macOS Finder Quick Action 默认启用按“企微名称”分组统计。
- 项目版本从 `0.1.3` 升级为 `0.1.4`。

详细发布说明：[docs/release-notes/v0.1.4.md](docs/release-notes/v0.1.4.md)
